...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Eduardo", "De Santis", "edesantis@live.com.ar", "350 634 2747", "EEUU 3000", "Admin");
            var customer = await CheckUserAsync("2020", "Eduardo", "De Santis", "eodesantis@gmail.com", "350 634 2747", "Rivadavia 3200", "Customer");
